...
var jqDialog = new function() {
	...
	this.confirm = function(message, callback_yes, callback_no,yes,no) {		
		this.createDialog(message);
		this.btYes.html(yes);//diko mou hack gia na pernei dika mou nai / oxi
		this.btNo.html(no);//diko mou hack gia na pernei dika mou nai / oxi
